...
When I first started with web development, CGI scripts was a thing and PHP was in version 3.x 😲 After not so long, I got confident with the [LAMP stack](<https://en.wikipedia.org/wiki/LAMP_(software_bundle)>), and it has been the setup on a majority of the projects I have worked on. That became my comfort zone.
